  ...
  describe("authService", () => {
    ...
    describe("registerUser", () => {
      it("should register a new user", async () => {
        ...
        const result = await registerUser("test@example.com", "password", "John", "Doe");
    ...
    describe("loginUser", () => {
      it("should log in a user with valid credentials", async () => {
        ...
        expect(result).toEqual({ token: "fake-jwt-token", refreshToken: "fake-refresh-token", role: "user" });
      });
    ...
    describe("refreshUserToken", () => {
      ...
      it("should throw an error if the refresh token is invalid", async () => {
        ...
        await expect(refreshUserToken("invalid-refresh-token")).rejects.toThrow("Invalid refresh token");
