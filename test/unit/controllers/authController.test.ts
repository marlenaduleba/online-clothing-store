...
describe("Auth Controller", () => {
  ...
  describe("register", () => {
    it("should register a user and return user data without password", async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith({
        message: "User registered successfully", // Poprawiony komunikat
  ...
  describe("login", () => {
    it("should log in a user and return token and role", async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith({
        message: "Login successful", // Poprawiony komunikat
        ...mockLoginResponse,
      });
    });
  ...
  describe("refreshToken", () => {
    it("should refresh a token and return a new one", async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith({
        message: "Token refreshed successfully", // Poprawiony komunikat
        ...mockNewToken,
      });
    });
