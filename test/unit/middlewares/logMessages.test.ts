...
describe("logMessages Middleware", () => {
  ...
  beforeEach(() => {
    ...
    mockResponse = {
      send: jest.fn(),
      statusCode: 200,
      getHeader: jest.fn().mockReturnValue("application/json"), // Mock getHeader to return JSON content type
    };
  ...
  it("should log a message in green for a successful response", () => {
    ...
    // Call the middleware
    logMessages(mockRequest as Request, mockResponse as Response, mockNext);
